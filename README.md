...
The app is built with Capacitor for cross-platform compatibility, and uses Ionic Framework (with Vue) for a native-like feel adapted to the two platforms.
